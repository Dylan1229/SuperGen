...
def add_inference_args(parser: argparse.ArgumentParser):
    ...
    # Two-stage generation arguments
    group.add_argument(
        "--two-stage-generation",
        action="store_true",
        help="Enable two-stage generation for high-resolution video.",
    )
    group.add_argument(
        "--upscale-factor",
        type=int,
    ...
    group.add_argument(
        ...
        type=int,
        default=0,
        help="Number of denoising steps for Stage 2 refinement in two-stage generation.",
    )

    group.add_argument(
        "--save-intermediate",
        action="store_true",
        help="Save intermediate results during two-stage generation.",
    )
    group.add_argument(
        "--output-dir",
        type=str,
        default=None,
        help="Directory to save intermediate results during two-stage generation.",
    )
    group.add_argument(
        "--shift-timesteps",
        type=str,
        default=None,
        help="Comma-separated list of steps to perform shift (e.g., '0,1,2,3,4,40,41,42,43,44,45,46'). If not provided, no shifting will occur.",
    )
    group.add_argument(
        "--load-prev-latents-path",
        type=str,
        default=None,
        help="Path to load previous latents from a .pt file for two-stage generation.",
    )
    group.add_argument(
        "--loop-step",
        type=int,
        default=8,
        help="Loop step for cache optimization.",
    )
    group.add_argument(
        "--enable-intra-tile-cache",
        action="store_true",
        help="Enable intra-tile cache optimization.",
    )
    group.add_argument(
        "--cache-thresh",
        type=float,
    ...
    group.add_argument(
        ...
        action="store_true",
        help="Enable region-aware cache optimization.",
    )
    group.add_argument(
        "--static-tile-cache-scale-factor",
        type=float,
        default=1.0,
        help="Scale factor for static tile cache.",
    )
